...
- **Loan** (Видача книги)
  ...
  - Book_ID (FK) - посилання на книгу
  - Member_ID (FK) - посилання на члена бібліотеки
  - Staff_ID (FK) - посилання на співробітника, який видав книгу
...
- **Fine** (Штраф)
  ...
  - Loan_ID (FK) - посилання на видачу
  - Member_ID (FK) - посилання на члена бібліотеки
...
**Зв'язки:**
- Genre **CATEGORIZES** Book (1:N) - один жанр може містити багато книг
- Book **IS_LOANED_IN** Loan (1:N) - одна книга може бути видана багато разів
- Member **BORROWS** Loan (1:N) - один член може взяти багато книг
- Staff **PROCESSES** Loan (1:N) - один співробітник може обробити багато видач
- Loan **HAS** Fine (1:N) - одна видача може мати багато штрафів
- Member **RECEIVES** Fine (1:N) - один член може мати багато штрафів

**Примітка**: Сутність Author поки що не прив'язана до інших сутностей у проекті.
